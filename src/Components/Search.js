  ...
  return (
    <div className="my-50 layout-row align-items-end justify-content-end">
      <label htmlFor="studentName">
        Student Name:
        <div>
          <input id="studentName" data-testid="studentName" type="text" className="mr-30 mt-10"></input>
        </div>
      </label>
      <label htmlFor="joiningDate">
        Joining Date:
        <div>
          <input id="joiningDate" data-testid="joiningDate" type="date" className="mr-30 mt-10"></input>
        </div>
      </label>
      <button onClick={() => onAdd(residents, setResidents, setErrorText)} type="button" data-testid="addBtn" className="small mb-0">
        Add
      </button>
    </div>
  );
